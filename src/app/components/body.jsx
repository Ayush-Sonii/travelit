       ...
       border-radius-sm flex flex-row border-radius-sm border-white border-solid border-2 rounded-md">
        <div className="content">
          ...
          <div className="buttons">
            <Link href="/login"><input className="btn btn1" type="button" value="Start Planning"/></Link>
            <Link href="/login"><input className="btn btn2" type="button" value="Select a Plan"/></Link>
          </div>
        </div>
        <div className="blank">
